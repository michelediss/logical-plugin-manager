 ...
 * Plugin URI: https://github.com/michelediss/logical-plugin-manager
 * Description: Centralized management for The Logical Theme.
 * Version: 1.0.0
 * Author: Michele Paolino
 * Author URI: https://michelepaolino.me
 * Text Domain: logical-plugin-manager
*/
...
$plugin_repositories = [
    'Logical Design System' => [
        'url' => 'https://github.com/michelediss/logical-design-system/releases/latest/download/logical-design-system.zip',
        ...
        'version' => '1.0',
        'plugin_uri' => 'https://github.com/michelediss/logical-design-system',
    ],
    'Logical SEO Toolbox' => [
        'url' => 'https://github.com/michelediss/logical-seo-toolbox/releases/latest/download/logical-seo-toolbox.zip',
        'description' => 'A lightweight SEO plugin to optimize your WordPress site for search engines.',
        'author' => 'Michele Paolino',
        'author_uri' => 'https://michelepaolino.me',
        'version' => '1.0',
        'plugin_uri' => 'https://github.com/michelediss/logical-seo-toolbox',
    ],
    'Logical Pods' => [
        'url' => 'https://github.com/michelediss/logical-pods/releases/latest/download/logical-pods.zip',
        'description' => 'Manages visibility of specific Pods metaboxes on pages and excecutes custom code.',
        'author' => 'Michele Paolino',
        'author_uri' => 'https://michelepaolino.me',
        'version' => '1.0',
        'plugin_uri' => 'https://github.com/michelediss/logical-pods',
    ],
];
...
function plugin_manager_page() {
    ...
    <div class="wrap">
        ...
        <form method="post" action="<?php echo admin_url('admin-post.php'); ?>">
            ...
            <!-- LOGICAL THEME PLUGINS (GitHub) -->
            <h2>The Logical Theme Plugins</h2>
                ...
                <tbody id="the-list">
                    <?php foreach ($plugin_repositories as $plugin_name => $plugin_data): ?>
                        ...
                        <tr class="<?php echo $row_class; ?>"
                            data-slug="<?php echo sanitize_title($plugin_name); ?>"
                            ...
                            <td class="column-description desc">
                                ...
                                <div class="<?php echo $row_class; ?> second plugin-version-author-uri">
                                    Version <?php echo esc_html($plugin_data['version']); ?>
                                    | By <a href="<?php echo esc_url($plugin_data['author_uri']); ?>">
                                        <?php echo esc_html($plugin_data['author']); ?>
                                    </a>
                                    | <a href="<?php echo esc_url($plugin_data['plugin_uri']); ?>"
                                         aria-label="Visit plugin site for <?php echo esc_html($plugin_name); ?>">
                                         Visit plugin site
                                      </a>
                                </div>
                            </td>
                            <td class="column-pull">
                                <button type="button" class="button"
                                        onclick="plugin_manager_pull_plugin('<?php echo esc_js($plugin_name); ?>')">
                                    Pull
                                </button>
                            </td>
                        </tr>
            ...
            <!-- WORDPRESS REPOSITORY PLUGINS (3 CATEGORIES) -->
            ...
            <table class="wp-list-table widefat plugins">
                <thead>
                    <tr>
                        <td id="cb" class="manage-column column-cb check-column">
                            <input id="cb-select-all-wp-base-1" type="checkbox">
                            <label for="cb-select-all-wp-base-1"><span class="screen-reader-text">Select All</span></label>
                        </td>
                        <th scope="col" class="manage-column column-name column-primary">Plugin</th>
                ...
                <tbody>
                    <?php foreach ($wp_repository_plugins as $plugin_slug => $plugin_data): ?>
                        <?php if (isset($plugin_data['category']) && $plugin_data['category'] === 'base'): ?>
                            <?php
                            ...
                            <tr class="<?php echo $row_class; ?>"
                                ...
                                <th scope="row" class="check-column">
                                    <label class="label-covers-full-cell"
                                           for="checkbox_wp_base_<?php echo md5($plugin_slug); ?>">
                                        <span class="screen-reader-text">
                                            Select <?php echo esc_html($plugin_info['name']); ?>
                                        </span>
                                    </label>
                                    <input type="checkbox" name="selected_wp_plugins[]"
                                           value="<?php echo esc_attr($plugin_slug); ?>"
                                           id="checkbox_wp_base_<?php echo md5($plugin_slug); ?>">
                                </th>
                                ...
                                <td class="column-install">
                                    ...
                                    <?php elseif ($is_installed): ?>
                                        <button type="button" class="button"
                                                onclick="plugin_manager_activate_plugin('<?php echo esc_js($plugin_slug); ?>')">
                                            Activate
                                        </button>
                                    <?php else: ?>
                                        <button type="button" class="button"
                                                onclick="plugin_manager_install_wp_plugin('<?php echo esc_js($plugin_slug); ?>')">
                                            Install
                                        </button>
                                    <?php endif; ?>
                                </td>
                ...
                <tfoot>
                    <tr>
                        <td id="cb" class="manage-column column-cb check-column">
                            <input id="cb-select-all-wp-base-2" type="checkbox">
                            <label for="cb-select-all-wp-base-2"><span class="screen-reader-text">Select All</span></label>
                        </td>
                        <th scope="col" class="manage-column column-name column-primary">Plugin</th>
                        <th scope="col" class="manage-column column-install">Install</th>
                    </tr>
            ...
            <table class="wp-list-table widefat plugins">
                <thead>
                    <tr>
                        <td id="cb" class="manage-column column-cb check-column">
                            <input id="cb-select-all-wp-optional-1" type="checkbox">
                            <label for="cb-select-all-wp-optional-1"><span class="screen-reader-text">Select All</span></label>
                        </td>
                        <th scope="col" class="manage-column column-name column-primary">Plugin</th>
                        <th scope="col" class="manage-column column-install">Install</th>
                    </tr>
                ...
                <tbody>
                    <?php foreach ($wp_repository_plugins as $plugin_slug => $plugin_data): ?>
                        <?php if (isset($plugin_data['category']) && $plugin_data['category'] === 'optional'): ?>
                            <?php
                                $plugin_info  = plugin_manager_get_wp_plugin_info($plugin_slug);
                                $plugin_file  = plugin_manager_get_plugin_file_by_slug($plugin_slug);
                                $is_installed = ($plugin_file !== null);
                            ...
                            <tr class="<?php echo $row_class; ?>"
                                ...
                                <th scope="row" class="check-column">
                                    <label class="label-covers-full-cell"
                                           for="checkbox_wp_optional_<?php echo md5($plugin_slug); ?>">
                                        <span class="screen-reader-text">
                                            Select <?php echo esc_html($plugin_info['name']); ?>
                                        </span>
                                    </label>
                                    <input type="checkbox" name="selected_wp_plugins[]"
                                           value="<?php echo esc_attr($plugin_slug); ?>"
                                           id="checkbox_wp_optional_<?php echo md5($plugin_slug); ?>">
                                </th>
                ...
                <tfoot>
                    <tr>
                        <td id="cb" class="manage-column column-cb check-column">
                            <input id="cb-select-all-wp-optional-2" type="checkbox">
                            <label for="cb-select-all-wp-optional-2"><span class="screen-reader-text">Select All</span></label>
                        </td>
                        <th scope="col" class="manage-column column-name column-primary">Plugin</th>
                        <th scope="col" class="manage-column column-install">Install</th>
                    </tr>
            ...
            <table class="wp-list-table widefat plugins">
                <thead>
                    <tr>
                        <td id="cb" class="manage-column column-cb check-column">
                            <input id="cb-select-all-wp-develop-1" type="checkbox">
                            <label for="cb-select-all-wp-develop-1"><span class="screen-reader-text">Select All</span></label>
                        </td>
                        <th scope="col" class="manage-column column-name column-primary">Plugin</th>
                        <th scope="col" class="manage-column column-install">Install</th>
                    </tr>
                ...
                <tbody>
                    <?php foreach ($wp_repository_plugins as $plugin_slug => $plugin_data): ?>
                        <?php if (isset($plugin_data['category']) && $plugin_data['category'] === 'develop'): ?>
                            <?php
                                $plugin_info  = plugin_manager_get_wp_plugin_info($plugin_slug);
                                $plugin_file  = plugin_manager_get_plugin_file_by_slug($plugin_slug);
                                $is_installed = ($plugin_file !== null);
                            ...
                            <tr class="<?php echo $row_class; ?>"
                                ...
                                <th scope="row" class="check-column">
                                    <label class="label-covers-full-cell"
                                           for="checkbox_wp_develop_<?php echo md5($plugin_slug); ?>">
                                        <span class="screen-reader-text">
                                            Select <?php echo esc_html($plugin_info['name']); ?>
                                        </span>
                                    </label>
                                    <input type="checkbox" name="selected_wp_plugins[]"
                                           value="<?php echo esc_attr($plugin_slug); ?>"
                                           id="checkbox_wp_develop_<?php echo md5($plugin_slug); ?>">
                                </th>
                ...
                <tfoot>
                    <tr>
                        <td id="cb" class="manage-column column-cb check-column">
                            <input id="cb-select-all-wp-develop-2" type="checkbox">
                            <label for="cb-select-all-wp-develop-2"><span class="screen-reader-text">Select All</span></label>
                        </td>
                        <th scope="col" class="manage-column column-name column-primary">Plugin</th>
                        <th scope="col" class="manage-column column-install">Install</th>
                    </tr>
    ...
    <script>
        ...
        // ===== BASE SELECT ALL =====
        document.getElementById('cb-select-all-wp-base-1').addEventListener('click', function (event) {
            var allBase = document.querySelectorAll('input[id^=\"checkbox_wp_base_\"]');
            for (var checkbox of allBase) {
                checkbox.checked = event.target.checked;
            }
        });
        document.getElementById('cb-select-all-wp-base-2').addEventListener('click', function (event) {
            var allBase = document.querySelectorAll('input[id^=\"checkbox_wp_base_\"]');
            for (var checkbox of allBase) {
                checkbox.checked = event.target.checked;
            }
        ...
        // ===== OPTIONAL SELECT ALL =====
        document.getElementById('cb-select-all-wp-optional-1').addEventListener('click', function (event) {
            var allOptional = document.querySelectorAll('input[id^=\"checkbox_wp_optional_\"]');
            for (var checkbox of allOptional) {
                checkbox.checked = event.target.checked;
            }
        });
        document.getElementById('cb-select-all-wp-optional-2').addEventListener('click', function (event) {
            var allOptional = document.querySelectorAll('input[id^=\"checkbox_wp_optional_\"]');
            for (var checkbox of allOptional) {
                checkbox.checked = event.target.checked;
            }
        ...
        // ===== DEVELOP SELECT ALL =====
        document.getElementById('cb-select-all-wp-develop-1').addEventListener('click', function (event) {
            var allDevelop = document.querySelectorAll('input[id^=\"checkbox_wp_develop_\"]');
            for (var checkbox of allDevelop) {
                checkbox.checked = event.target.checked;
            }
        });
        document.getElementById('cb-select-all-wp-develop-2').addEventListener('click', function (event) {
            var allDevelop = document.querySelectorAll('input[id^=\"checkbox_wp_develop_\"]');
            for (var checkbox of allDevelop) {
                checkbox.checked = event.target.checked;
            }
